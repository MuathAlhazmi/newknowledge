export const arCopy = {
  ...
  /** Admin: إضافة مادة (PDF أو Word) */
  materialUpload: {
    fileLabel: "ملف المادة (PDF أو Word)",
    folderLabel: "المجلد (اختياري)",
    folderRoot: "بدون مجلد (الرئيسي)",
    titleLabel: "عنوان المادة",
    titlePlaceholder: "مثال: الوحدة الأولى",
    sectionTitle: "إضافة مادة جديدة",
    sectionHint:
      "املأ العنوان واختر ملف PDF أو Word (DOCX) — يُعرَف النوع تلقائيًا من الملف. ثم اضغط «إضافة المادة» مرة واحدة (رفع + حفظ تلقائيًا).",
    addMaterialButton: "إضافة المادة",
    addMaterialPending: "جارٍ الرفع والحفظ…",
    saveSuccess: "تمت إضافة المادة إلى الدورة.",
    fileSelectedBadge: "ملف جاهز",
    dropHint: "اسحب ملف PDF أو Word (DOCX) هنا، أو اختر ملفًا",
    dropFormatsBadge: "PDF / DOCX",
    ...
    errors: {
      unsupportedType: "يرجى اختيار ملف بصيغة PDF أو DOCX.",
      kindMismatch: "يجب أن يكون الملف من نفس نوع المادة (PDF أو DOCX).",
      notPdf: "يرجى اختيار ملف بصيغة PDF.",
      notDocx: "يرجى اختيار ملف بصيغة DOCX.",
      tooLarge: "حجم الملف يتجاوز الحد المسموح (٥٠ ميغابايت).",
      invalidPdf: "الملف المحدد ليس مستند PDF صالحًا.",
      invalidDocx: "الملف المحدد ليس مستند Word (DOCX) صالحًا.",
  ...
  materialsAdmin: {
    ...
    listSubtitleEditor: "يمكنك تعديل العنوان أو نقل المادة بين المجلدات أو حذفها من الأزرار أدناه.",
    kindPdf: "PDF",
    kindDocx: "DOCX",
    openFilePdf: "فتح PDF",
    openFileDocx: "تنزيل DOCX",
    moveFolderLabel: "المجلد",
    moveFolderRoot: "الرئيسي",
    moveApply: "تطبيق",
    movedFolder: "تم تحديث المجلد.",
    folderNotEmpty: "لا يمكن حذف مجلد يحتوي موادًا أو مجلدات فرعية.",
    foldersSectionTitle: "المجلدات",
    foldersSectionHint: "نظّم المواد داخل مجلدات. احذف المجلد فقط إذا كان فارغًا.",
    createFolderPanelTitle: "إنشاء مجلد جديد",
    createFolderPanelHint:
      "اختر اسمًا واضحًا يصف المحتوى. يمكنك وضع المجلد داخل مجلد آخر لتكوين هيكل متداخل (اختياري).",
    newFolderName: "اسم المجلد",
    newFolderNamePlaceholder: "مثال: الوحدة الثانية — التطبيقات",
    newFolderParent: "داخل مجلد (اختياري)",
    newFolderSubmit: "إنشاء المجلد",
    folderNameRequired: "يرجى إدخال اسم المجلد.",
    creatingFolder: "جارٍ الإنشاء…",
    foldersCurrentLabel: "المجلدات الحالية",
    foldersEmptyState: "لا توجد مجلدات بعد. أنشئ مجلدًا أعلاه ثم اربط المواد به من جدول المواد.",
    folderCreated: "تم إنشاء المجلد.",
    folderRenamed: "تم تحديث اسم المجلد.",
    folderDeleted: "تم حذف المجلد.",
    confirmDeleteFolder: "حذف هذا المجلد؟ يجب أن يكون فارغًا (بدون مواد أو مجلدات فرعية).",
    renameFolder: "تسمية",
    deleteFolder: "حذف",
    cancelFolderEdit: "إلغاء",
    saveFolderName: "حفظ",
    editTitle: "تعديل العنوان",
    saveTitle: "حفظ",
    cancel: "إلغاء",
    deleteMaterialButton: "حذف",
    ...
    errors: {
      ...
      deleteMaterialFailed: "تعذر حذف المادة.",
      notFound: "المادة غير موجودة.",
      folderOp: "تعذر إكمال العملية على المجلد.",
    },
  },
  announcements: {
...
export function arCountTeamsSessions(n: number): string {
